        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-4 opacity-0 animate-fade-up stagger-2">
              <span className="font-semibold text-foreground">Veterinary Surgeon</span> |{" "}
              <span className="font-semibold text-foreground">Biomedical Researcher</span> |{" "}
              <span className="font-semibold text-foreground">Anatomy & Histology Specialist</span>
            </p>
          ...
          <div className="order-1 lg:order-2 flex justify-center opacity-0 animate-fade-up stagger-2">
            <div className="relative">
              ...
              {/* Floating badges */}
              <div className="absolute -right-4 top-1/4 bg-background rounded-xl shadow-card px-4 py-3 border border-border/50 animate-float">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 bg-accent rounded-full" />
                  <span className="text-sm font-medium">BVC Reg. 8026</span>
                </div>
              </div>
              
              <div className="absolute -left-4 bottom-1/4 bg-background rounded-xl shadow-card px-4 py-3 border border-border/50 animate-float" style={{ animationDelay: "1s" }}>
                <div className="flex items-center gap-2">
